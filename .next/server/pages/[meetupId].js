...
const MeetupDetails = props => {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(external_react_["Fragment"], {
    children: [/*#__PURE__*/Object(jsx_runtime_["jsxs"])(head_default.a, {
      ...
      }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("meata", {
        name: "description",
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://lucas:VzuDlw8HdWav1qfD@cluster0.6tbldem.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
